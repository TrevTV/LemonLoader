...
public:
	...
	static void DebugLog(const char* txt) { if (LemonLoader::DebugMode) Log((std::string("[DEBUG] ") + txt)); }
	static void DebugLog(const char* txt, ConsoleColor color) { if (LemonLoader::DebugMode) Log((std::string("[DEBUG] ") + txt), color); };
	...
	static void DebugLogError(const char* txt) { if (LemonLoader::DebugMode) LogError((std::string("[DEBUG] ") + txt)); }
	static void DebugLogError(const char* namesection, const char* txt) { if (LemonLoader::DebugMode) LogError(namesection, (std::string("[DEBUG] ") + txt).c_str()); }
