...
void* HookManager::Hooked_runtime_invoke(const void* method, void* obj, void** params, void** exc)
{
	...
	if ((strstr(method_name, "Internal_ActiveSceneChanged") != NULL) || (!LemonLoader::IsGameIl2Cpp && (strstr(method_name, "UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize") != NULL)))
	{
		if (LemonLoader::IsGameIl2Cpp)
