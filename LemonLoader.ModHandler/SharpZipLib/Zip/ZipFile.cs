...
using LemonLoader.ICSharpCode.SharpZipLib.Encryption;
#endif

using LemonLoader.ICSharpCode.SharpZipLib.Core;
using LemonLoader.ICSharpCode.SharpZipLib.Checksums;
using LemonLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using LemonLoader.ICSharpCode.SharpZipLib.Zip.Compression;

namespace LemonLoader.ICSharpCode.SharpZipLib.Zip 
{
	...
	/// using System.IO;
	/// 
	/// using LemonLoader.ICSharpCode.SharpZipLib.Zip;
	/// 
	/// class MainClass
	/// {
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="LemonLoader.ICSharpCode.SharpZipLib.Zip.ZipException">
