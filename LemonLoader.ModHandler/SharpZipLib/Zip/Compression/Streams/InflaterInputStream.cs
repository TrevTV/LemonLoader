...
namespace LemonLoader.ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	/// as the <see cref="LemonLoader.ICSharpCode.SharpZipLib.GZip.GZipInputStream">GZipInputStream</see>.
	///
